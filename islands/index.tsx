...
export default function IndexIsland() {
 /*  const [load,setLoad]=useState(false)
  ...
  return (
    <>
      ...
      {load ? <div class="h-full h-screen bg-black banner" >
        </div>:
      <>
      <div class="container">
        <SideBar/>
 <div class="wrapper">
  ...
  <div class="main-container">
   ...
   <div class="small-header anim" style="--delay: .3s">Teams</div>
   <div class="videos">
    <div class="video anim" style="--delay: .4s">
     <div class="video-time">8 min</div>
     <div class="video-wrapper">
      <video src="https://player.vimeo.com/external/436572488.sd.mp4?s=eae5fb490e214deb9ff532dd98d101efe94e7a8b&profile_id=139&oauth2_token_id=57447761">
      </video>
    ...
    <div class="video anim" style="--delay: .5s">
     ...
     <div class="video-name text-4xl">EQUIPO</div>
    ...
    <div class="video anim" style="--delay: .6s">
     ...
     <div class="video-wrapper">
        <img src="/team.png" alt="" srcset="" />
     {/*  <video src="https://player.vimeo.com/external/436553499.sd.mp4?s=0e44527f269278743db448761e35c5e39cfaa52c&profile_id=139&oauth2_token_id=57447761">
      </video> */}
      <div class="author-img__wrapper video-author">
       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
        <path d="M20 6L9 17l-5-5" />
    ...
    <div class="video anim" style="--delay: .7s">
     ...
     <div class="video-wrapper">
      <video src="https://player.vimeo.com/external/361861493.sd.mp4?s=19d8275ca755d653042a87ef28b2f0b2eabf57d0&profile_id=139&oauth2_token_id=57447761">
